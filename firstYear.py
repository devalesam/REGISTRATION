...
class Login_window:
    def __init__(self,root):
        ...
        semister1=Label(frame1,text="semester 1",font=("times new roman",18,"bold"),bg="white",fg="grey").place(x=30,y=90)
        self.var_chk=IntVar()
        ...
        semister2=Label(frame1,text="semester 2",font=("times new roman",18,"bold"),bg="white",fg="grey").place(x=30,y=180)
        self.var_chk2=IntVar()
        Chk=Checkbutton(frame1,text="OP",variable=self.var_chk2,onvalue=1,offvalue=0,bg="white",font=("times new roman",12)).place(x=50,y=225)
        Chk=Checkbutton(frame1,text="MA",variable=self.var_chk2,onvalue=2,offvalue=0,bg="white",font=("times new roman",12)).place(x=100,y=225)
        Chk=Checkbutton(frame1,text="WP",variable=self.var_chk2,onvalue=3,offvalue=0,bg="white",font=("times new roman",12)).place(x=150,y=225)
        Chk=Checkbutton(frame1,text="NS",variable=self.var_chk2,onvalue=4,offvalue=0,bg="white",font=("times new roman",12)).place(x=200,y=225)
